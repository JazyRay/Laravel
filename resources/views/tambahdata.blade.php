...
<html lang="en">
  ...
  <body>
    <h1 class="text-center mb-5">Tambah Data Pasien</h1>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
          <div class="col-8">
            <div class="card">
              <div class="cardbody">
                <form style="margin: 15px;" action="/insertdata" method="POST" enctype="multipart/form-data">
                @csrf
                  <div class="mb-3">
                ...
                <div class="mb-3">
                  ...
                  <input type="number" name="NomorTelepon" class="form-control" id="exampleInputEmail" aria-describedby="emailHelp">
              </div>
